...
// koneksi ke database
$conn = mysqli_connect("127.0.0.1", "root", "", "softwareengineering");
if (!$conn) {
...
function registrasi($data)
{
	...
	mysqli_query($conn, "INSERT INTO users VALUES('','$role','$username', '$password','$name')");
...
{
	global $conn;
	$idaddshipment = $_GET["idaddshipment"];;
