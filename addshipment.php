...
<body>
    <div class="hero" id="Home">
        <nav>
            <h2 class="header" id="navbar">Kebut<span>Express</span></h2>
            <ul>
            ...
            <form action="" method="post" enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="shipmenttype" aria-label="Default select example" id="shipmenttype">
                        <option selected value="cepat">Cepat</option>
                        <option selected value="kebut">Kebut</option>
                        <option selected value="kilat">Kilat</option>
                    </select>
                </div>
                <div class="col-md-6">
